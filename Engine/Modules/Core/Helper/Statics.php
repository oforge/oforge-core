...
class Statics {
    ...
    public const PUBLIC_DIR         = GLOBAL_SEPARATOR . Statics::VAR_DIR . GLOBAL_SEPARATOR . "public";
    public const IMAGES_DIR         = Statics::PUBLIC_DIR . GLOBAL_SEPARATOR . "images";
    public const CACHE_DIR          = GLOBAL_SEPARATOR . Statics::VAR_DIR . GLOBAL_SEPARATOR . "cache";
    public const RESULT_CACHE_DIR   = Statics::CACHE_DIR . GLOBAL_SEPARATOR . "result";
    public const PROXY_CACHE_DIR    = Statics::CACHE_DIR . GLOBAL_SEPARATOR . "proxy";
    public const FUNCTION_CACHE_DIR = Statics::CACHE_DIR . GLOBAL_SEPARATOR . "functions";
    public const THEME_CACHE_DIR    = Statics::CACHE_DIR . GLOBAL_SEPARATOR . "theme";
    public const DB_CACHE_DIR       = Statics::CACHE_DIR . GLOBAL_SEPARATOR . "db";
    public const ENDPOINT_CACHE_DIR = ROOT_PATH . self::CACHE_DIR . GLOBAL_SEPARATOR . 'endpoints';
    public const ASSET_CACHE_DIR    = Statics::PUBLIC_DIR . GLOBAL_SEPARATOR . Statics::ASSETS_DIR;
    ...
    public const DB_CACHE_FILE      = Statics::DB_CACHE_DIR . GLOBAL_SEPARATOR . "db.cache";
    public const IMPORTS_DIR        = GLOBAL_SEPARATOR . Statics::VAR_DIR . GLOBAL_SEPARATOR . "imports";
    public const DEFAULT_THEME      = "Base";
    //public const MAIL_TEMP_CACHE_DIR  = Statics::CACHE_DIR . GLOBAL_SEPARATOR . 'mail';
    /**
     * Relative path of logs folder.
     */
    public const LOGS_DIR = GLOBAL_SEPARATOR . Statics::VAR_DIR . GLOBAL_SEPARATOR . 'logs';
    /**
